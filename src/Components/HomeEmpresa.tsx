        ...
        <div style={{height:"100vh",width:"100%",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",flexWrap:"wrap"}}>
            {
                empresas.map((empresa:IEmpresa)=>(
                    <CardSucursal key={empresa.id} empresa={{id:empresa.id, cuil:empresa.cuil, nombre:empresa.nombre, razonSocial:empresa.razonSocial, baja:empresa.baja}}></CardSucursal>
                ))
            }
        </div>
    )
